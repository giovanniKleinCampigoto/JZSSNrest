...
public class Functions {
	 ...
	 *
	 * @param trader
	 *            Survivor that is trading
	 * @param wantsToTrade
	 *            Survivor that is wanting to trade
	 * @param tradeT
	 *            trade item
	 * @param ammountT
	 *            trade item ammount
	 * @param tradeWTT
	 *            want's to trade item
	 * @param ammountWTT
	 *            want's to trade ammount
	 */
	public void trade(Survivor trader, Survivor wantsToTrade, String tradeT, int ammountT, String tradeWTT,
			int ammountWTT) {
		...
		System.out.println("Survivor " + wantsToTrade.getName() + " wants to trade " + tradeWTT + " X [" + ammountWTT
				+ "] " + " with " + trader.getName() + " for " + tradeT + " X [" + ammountT + "] ");
